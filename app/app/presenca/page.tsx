    ...
    <div>
      ...
      <div style={{ display:'flex', gap:8, marginBottom:14 }}>
        ...
        <input type="month" value={mes} onChange={e => setMes(e.target.value)}
          style={{ marginLeft:'auto', border:'1px solid #d1d5db', borderRadius:6, padding:'6px 10px', fontSize:13 }} />
      </div>
      ...
      {loading ? (
        ...
        <div style={{ overflow:'auto', border:'1px solid #e5e7eb', borderRadius:8, maxHeight:'calc(100vh - 280px)' }}>
                    ...
                    {dias.map((d,di) => {
                      ...
                      return (
                        <td key={di} onClick={() => abrirModal(func.id, func.nome, key)}
                          ...
                          title={p ? p.tipo : 'Clique para lançar'}>
        ...
        <div style={{ position:'fixed', inset:0, background:'rgba(0,0,0,0.5)', zIndex:50, display:'flex', alignItems:'center', justifyContent:'center', padding:16 }}>
          <div style={{ background:'#fff', borderRadius:16, width:'100%', maxWidth:420, maxHeight:'90vh', overflowY:'auto' }}>
            ...
            <div style={{ padding:20, display:'flex', flexDirection:'column', gap:14 }}>
              ...
              <div>
                <label style={{ fontSize:12, fontWeight:600, color:'#374151', display:'block', marginBottom:4 }}>Tipo de presença</label>
            ...
            <div style={{ padding:'12px 20px', borderTop:'1px solid #f3f4f6', display:'flex', gap:8, justifyContent:'space-between' }}>
              <div>
                {modal.atual && <button onClick={remover} style={{ padding:'7px 14px', borderRadius:8, border:'none', background:'#dc2626', color:'#fff', cursor:'pointer', fontSize:13, fontWeight:600 }}>Remover</button>}
              </div>
